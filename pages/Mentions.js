    ...
    <div>
      <Layout>
        <div className="p-10 text-justify">
          <h1 className="font-bold my-4">IDENTITÉ</h1>
          Nom du site web : Charles CANTIN <br />
          Adresse : https://zen-mestorf-4d5f9c.netlify.app/ <br />
          Propriétaire : Charles CANTIN <br />
          Responsable de publication : guibacsolutions <br />
          Conception et réalisation : GBT <br />
          Animation : GBT <br />
          Hébergement : Netlify <br />
          <h1 className="font-bold my-4">CONDITIONS D’UTILISATION</h1>
          ...
          du site sont présentés à titre indicatif, n’ont pas de caractère
          ...
          <h1 className="font-bold my-4">INTERACTIVITÉ</h1>
          ...
          <h1 className="font-bold my-4">PROPRIÉTÉ INTELLECTUELLE</h1>
          ...
          les droits de propriété intellectuelle ou les droits d’usage. 1 Toute
          ...
          constitutive d’une contrefaçon et poursuivie. 4 Les marques et logos
          reproduits sur le site sont déposés par les sociétés qui en sont
          propriétaires. <h1 className="font-bold my-4">LIENS</h1>
          Liens sortants Le propriétaire du site décline toute responsabilité et
          n’est pas engagé par le référencement via des liens hypertextes, de
          ressources tierces présentes sur le réseau Internet, tant en ce qui
          concerne leur contenu que leur pertinence. Liens entrants Le
          propriétaire du site autorise les liens hypertextes vers l’une des
          pages de ce site, à condition que ceux-ci ouvrent une nouvelle fenêtre
          et soient présentés de manière non équivoque afin d’éviter : tout
          risque de confusion entre le site citant et le propriétaire du site
          ainsi que toute présentation tendancieuse, ou contraire aux lois en
          vigueur. Le propriétaire du site se réserve le droit de demander la
          suppression d’un lien s’il estime que le site source ne respecte pas
          les règles ainsi définies.
          <h1 className="font-bold my-4">CONFIDENTIALITÉ </h1>
